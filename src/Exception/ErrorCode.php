...
final class ErrorCode {
    ...
    public const BAG_TYPE_MISMATCH = 'BAG_003';
    public const BAG_SCHEMA_ERROR = 'BAG_SCHEMA_003';
    public const BAG_MISSING_PARAMETER = 'BAG_PARAMETER_007';
    public const BAG_NOT_FOUND_PARAMETER = 'BAG_PARAMETER_002';
    public const BAG_UNKNOWN_TYPE = 'BAG_TYPE_003';
    public const BAG_TYPE_WAIT_MISMATCH = 'BAG_TYPE_007';
    ...
    public const API_DOMAIN_STATUS_INVALID_TYPE     = 'API_DOMAIN_002';
    public const API_TYPE_STATUS_INVALID_TYPE       = 'API_TYPE_002';
    ...
    public const CONTAINER_PROCESSING_STEP_STAGE_INVALID_TYPE   = 'CONTAINER_PROCESSING_STEP_STAGE_003';
    public const STOCK_PROCESSING_STEP_STAGE_INVALID_TYPE   = 'STOCK_PROCESSING_STEP_STAGE_003';
    public const ZONE_PROCESSING_STEP_STAGE_INVALID_TYPE   = 'ZONE_PROCESSING_STEP_STAGE_003';
