...
use WarehouseCore\Payload\VO\Audit\ZoneMovementArchiveVO;

final class ZoneMovementArchiveRepository extends Repository {
    public function hydrate(
        array $raw
    ): ZoneMovementArchiveVO {
        return ZoneMovementArchiveVO::fromRaw($raw);
    }
