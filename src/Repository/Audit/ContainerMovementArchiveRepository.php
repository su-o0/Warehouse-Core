...
use WarehouseCore\Payload\VO\Audit\ContainerMovementArchiveVO;

final class ContainerMovementArchiveRepository extends Repository {
    public function hydrate(
        array $raw
    ): ContainerMovementArchiveVO {
        return ContainerMovementArchiveVO::fromRaw($raw);
    }
